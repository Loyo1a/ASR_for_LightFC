...
dataset_dict = dict(
    ...
    lasot_ext=DatasetInfo(module=pt % "lasot_ext", class_name="LaSOTExtDataset",kwargs=dict()),

    uot=DatasetInfo(module=pt % 'uot', class_name='UOTDataset', kwargs=dict()),
    uot_sim=DatasetInfo(module=pt % 'uot', class_name='UOTDataset_SimSubset', kwargs=dict()),
    uot_unsim=DatasetInfo(module=pt % 'uot', class_name='UOTDataset_unSimSubset', kwargs=dict()),

    utb=DatasetInfo(module=pt % 'utb', class_name='UTBDataset', kwargs=dict()),
    utb_sim=DatasetInfo(module=pt % 'utb', class_name='UTBSimDataset', kwargs=dict()),
    utb_unsim=DatasetInfo(module=pt % 'utb', class_name='UTBunSimDataset', kwargs=dict()),
...
def load_dataset(name: str, env_num: int):
