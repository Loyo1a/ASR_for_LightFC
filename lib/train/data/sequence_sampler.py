...
class SequenceSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap, processing,
    ...
    def __getitem__(self, index):
        ...
        template_bbox = template_anno['bbox']  # tensor -> numpy array
        search_bbox = search_anno['bbox']   # tensor -> numpy array

        data = TensorDict({
            'template_images': template_frames,
            'template_anno': template_bbox,
            'template_masks': None,
