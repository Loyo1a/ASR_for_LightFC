...
from lib.models.lightfc.backbone import tiny_vit_5m_224
from lib.models.lightfc.fusion.fem import LFEM
from lib.models.lightfc.head import CenterPredictor
...
class lightTrack_track(nn.Module):
    def __init__(self):
        ...
        self.head = CenterPredictor(inplanes=192, channel=256)
